...
# API Endpoints for Aries Protocol
swap_url = 'https://aptos-network.pro/api/ariesprotocol/swap'
add_liquidity_url = 'https://aptos-network.pro/api/ariesprotocol/addLiquidity'
check_liquidity_url = 'https://aptos-network.pro/api/ariesprotocol/liquidity'
